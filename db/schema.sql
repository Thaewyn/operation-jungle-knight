...
CREATE TABLE hardware_ref (
  ...
  damage_type INT NOT NULL, -- or varchar?
  strength INT NOT NULL,
  rarity INT NOT NULL, -- or varchar?
  PRIMARY KEY(id)
);
...
CREATE TABLE enemy_attack_ref (
  ...
  effect INT NOT NULL, -- or varchar?
  damage_type INT NOT NULL, -- or varchar?
  strength INT NOT NULL,
...
-- is enemy attack list really needed if you just put enemyid_fk in enemy_attack_ref?